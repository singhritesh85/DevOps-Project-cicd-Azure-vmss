...
6. To create the end-to-end infrastructure I have created a shell script create-infra.sh, provide execute permission to this file and run the shell script.
7. For deletion of the resources you can use terraform destroy -auto-approve.
````
